...
from snsaccounts.models import CustomUser
...
class newsPhotoPost(models.Model):
    '''投稿されたデータを管理するモデル
    '''
    # CustomUserモデル(のuser_id)とnewsPhotoPostモデルを
    # 1対多の関係で結び付ける
    # CustomUserが親でnewsPhotoPostが子の関係となる
    ...
    # Categoryモデル(のtitle)とnewsPhotoPostモデルを
    # 1対多の関係で結び付ける
    # Categoryが親でnewsPhotoPostが子の関係となる
